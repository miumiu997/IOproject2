...
void cargarFile(GtkWidget *widget, gpointer user_data){ 
    ...
    gtk_spin_button_set_value(spinObjetos,atoi(palabra));
    ...
    gtk_spin_button_set_value(spinCapacity,atoi(palabra));
    palabra = (char*)calloc(1, sizeof(char));
    largo = 0;
    ...
    if (bounded)
    {
        ...
        for (i = 0; i < total; ++i)
        {
            ...
            gtk_entry_set_text(capacidades[0][i],g_strdup_printf("%d",atoi(palabra)));
            palabra = (char*)calloc(1, sizeof(char));
            largo = 0;
            ...
            gtk_entry_set_text(capacidades[1][i],g_strdup_printf("%d",atoi(palabra)));
            palabra = (char*)calloc(1, sizeof(char));
            largo = 0;
            ...
            gtk_entry_set_text(capacidades[2][i],g_strdup_printf("%d",atoi(palabra)));
            palabra = (char*)calloc(1, sizeof(char));
            largo = 0;
        }
...
int main(int argc, char *argv[])
{
    ...
    btnCargar = GTK_WIDGET (gtk_builder_get_object (gtkBuilder, "buttonCargar"));
